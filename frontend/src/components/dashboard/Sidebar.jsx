...
import { studentNavItems, recruiterNavItems } from './navConfig';
...
function Sidebar({ isOpen = false, onClose }) {
    ...
    const navItems =
        user?.role === 'recruiter' ? recruiterNavItems : studentNavItems;
            ...
            >
                <div className="flex items-center justify-between border-b border-[#e2e8f0] px-5 py-4">
                    ...
                    <button
                        type="button"
                        onClick={onClose}
                        className="rounded-xl p-2 text-[#64748b] transition-all duration-200 ease-in-out hover:bg-slate-50 hover:text-[#0f172a] lg:hidden"
                ...
                <div className="border-t border-[#e2e8f0] p-4">
                    <button
                        ...
                        className="flex w-full items-center justify-center gap-2 rounded-xl border border-[#e2e8f0] px-4 py-2.5 text-sm font-medium text-[#64748b] transition-all duration-200 ease-in-out hover:border-red-200 hover:bg-red-50 hover:text-red-600"
                    >
